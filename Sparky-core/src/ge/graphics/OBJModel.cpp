...
#include <ge/String.h>
#include <ge/utils/StringUtils.h>
#include <ge/utils/FileUtils.h>
...
namespace ge { namespace graphics {
	...
	void Model::InsertVertex(std::vector<Vertex>& vertices, std::vector<uint>& indices, std::unordered_map<IndexSet, int32>& mapping, VertexSet& inputVertices, IndexSet& indexSet)
	{
		...
		{
			mapping[indexSet] = (int32)vertices.size();
